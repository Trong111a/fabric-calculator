...
const resources = {
    en: {
        translation: {
            ...
            "seam_allowance": "Seam Allowance (m)",
            "effective_width": "Effective width",
            "formula_norm": "Fabric length = Total area × (1 + %Waste) ÷ (Fabric width - Seam allowance)",
            ...
            "semi_finished_title": "Semi-finished Area",
            "semi_finished_formula": "Semi = Finished × (1 + % finished allowance)",
            "finished_area_label": "Total finished (polygon)",
            "semi_waste_pct": "% Semi-finished",
            "custom_pct": "Other",
            "semi_finished_result_label": "Semi-finished area",
            "semi_finished_hint": "This area is used in the fabric norm calculation below",
            "area_source_label": "Area source:",
    ...
    vi: {
        translation: {
            ...
            "col_area_one": "Diện tích 1 chi tiết",
            "area_m2": "Diện tích (m²)",
            ...
            "export_waste_fab": "% Hao phí sản xuất",
            "export_fabric_width": "Khổ vải (m)",

            "semi_finished_title": "Tính diện tích bán thành phẩm",
            "semi_finished_formula": "BTP = Thành phẩm × (1 + % bán thành phẩm)",
            "finished_area_label": "Tổng thành phẩm (polygon)",
            "semi_waste_pct": "% Bán thành phẩm",
            "custom_pct": "Khác",
            "semi_finished_result_label": "Diện tích bán thành phẩm",
            "semi_finished_hint": "Diện tích BTP được dùng để tính định mức vải ở dưới",
            "area_source_label": "Nguồn diện tích:",

            "show_more": "↓ Xem thêm ({{count}} còn lại)",
            "collapse": "↑ Thu gọn",
